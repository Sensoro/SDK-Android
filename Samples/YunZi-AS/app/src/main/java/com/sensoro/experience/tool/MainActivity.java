...
public class MainActivity extends AppCompatActivity implements PermissionsResultObserve {
                ...
                if (beaconsFragment.isVisible()) {
                    ...
                    for (Beacon beacon : arg0) {
                        ...
                        if (TextUtils.isEmpty(beaconFilter)) {
                            ...
                            String matchString = String.format(matchFormat, beacon.getSerialNumber(), beacon.getMajor
                                    (), beacon.getMinor());
    ...
    private void showNotification(final Beacon beacon, final boolean isIn) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                PendingIntent pendingIntent = PendingIntent.getActivity(MainActivity.this, 0, intent, PendingIntent
                        .FLAG_UPDATE_CURRENT);
...
//		// }
    ...
    public void onPermissionGranted() {
        showFragment(0);
        Log.d("main", "onPermissionGranted: 权限获取完毕 ");
    }
